...
- **SLO 6** is the same undocumented-gap situation as SLO 5, for a different scheduled
  ...
  [issue #607](https://github.com/kubestellar/console-marketplace/issues/607) (mechanism
  tracker; the doc-only fix that added this row was tracked in the now-closed
