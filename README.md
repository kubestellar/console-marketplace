...
| The daily `stale.yml` run stops completing (stale issue/PR triage silently halts) | [`runbooks/scheduled-scan-alert-gap.md#stale-issues-workflow`](./runbooks/scheduled-scan-alert-gap.md#stale-issues-workflow) — no automated alert exists yet, manual detection only; see [issue #607](https://github.com/kubestellar/console-marketplace/issues/607) (#598 was closed as doc-only; #607 is the active mechanism tracker) |
