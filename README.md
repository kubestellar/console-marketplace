...
| The weekly `fuzz.yml`/`codeql.yml`/`scorecard.yml` scans stop completing | **Not yet covered** — see [`runbooks/SLO.md`](./runbooks/SLO.md#slis-and-slos) and [issue #573](https://github.com/kubestellar/console-marketplace/issues/573); no failure alert or runbook exists for these three workflows today |
