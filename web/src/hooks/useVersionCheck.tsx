  ...
  useEffect(() => {
    ...
    const checkVersion = async () => {
      try {
        ...
        // Bounded, fixed-shape record so a proxy/API failure leaves a trace somewhere;
        // never logs the raw response body or other unbounded input.
        console.error('VERSION_CHECK_SUMMARY:', {
